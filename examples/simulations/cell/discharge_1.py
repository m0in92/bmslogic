...
if __name__ == "__main__":
    ...
    electrolyte: cell_sim.Electrolyte = cell_sim.Electrolyte(L=L_e, conc=c_init_e, kappa=kappa_e, epsilon=epsilon_e, brugg=brugg_e)
    ...
    dc: cell_sim.Discharge = cell_sim.Discharge(current=discharge_current, V_min=V_min, soc_lib_min=soc_lib_min, soc_lib=soc_lib)
