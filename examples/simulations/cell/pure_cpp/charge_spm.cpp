...
{
    double temp = 298.15;
    double soc_n = 0.01890232;
    double soc_p = 0.989011;

    double charge_current = 1.65;
    double V_min = 4.2;
    double SOC_lib_max = 0.0;
    double SOC_lib = 0.0;
