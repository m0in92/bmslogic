...
static double SOC_init = 0.98901; // initial electrode SOC
...
// Battery cell parameters below
double V_max = 4.2;  // [V]
double soc_lib_max = 1.0;
double soc_lib_init = 0.0;

int main()
{
    // Polynomial approximation
    PolynomialApprox poly_solver = PolynomialApprox(electrode_type, c_init, "higher");
    Charge cycler = Charge(i_app, V_max, soc_lib_max, soc_lib_init);
