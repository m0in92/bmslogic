...
with open(os.path.join(FILE_DIR, "saved_results", "poly_higher_neg_discharge_time.pkl"), "rb") as pkl_cn_file:
    lst_poly_higher_time: list = pickle.load(pkl_cn_file)

with open(os.path.join(FILE_DIR, "saved_results", "poly_higher_neg_discharge_soc.pkl"), "rb") as pkl_cn_file:
    lst_poly_higher_soc: list = pickle.load(pkl_cn_file)

with open(os.path.join(FILE_DIR, "saved_results", "poly_two_neg_discharge_time.pkl"), "rb") as pkl_cn_file:
    lst_poly_two_time: list = pickle.load(pkl_cn_file)

with open(os.path.join(FILE_DIR, "saved_results", "poly_two_neg_discharge_soc.pkl"), "rb") as pkl_cn_file:
