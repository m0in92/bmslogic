...
with open(os.path.join(FILE_DIR, "saved_results", "poly_higher_neg_discharge_time.pkl"), "wb") as pkl_file:
    pickle.dump(lst_poly_time, pkl_file)

with open(os.path.join(FILE_DIR, "saved_results", "poly_higher_neg_discharge_soc.pkl"), "wb") as pkl_file:
    pickle.dump(lst_poly_soc, pkl_file)

with open(os.path.join(FILE_DIR, "saved_results", "poly_two_neg_discharge_time.pkl"), "wb") as pkl_file:
    pickle.dump(lst_poly_two_time, pkl_file)

with open(os.path.join(FILE_DIR, "saved_results", "poly_two_neg_discharge_soc.pkl"), "wb") as pkl_file:
