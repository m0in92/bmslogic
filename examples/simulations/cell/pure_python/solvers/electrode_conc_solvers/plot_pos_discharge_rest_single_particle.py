...
with open(os.path.join(FILE_DIR, "saved_results", "pos_discharge_rest_cn_time.pkl"), "rb") as pkl_cn_file:
    lst_cn_time: list = pickle.load(pkl_cn_file)

with open(os.path.join(FILE_DIR, "saved_results", "pos_discharge_rest_cn_soc.pkl"), "rb") as pkl_cn_file:
    lst_cn_soc: list = pickle.load(pkl_cn_file)

with open(os.path.join(FILE_DIR, "saved_results", "pos_discharge_rest_eigen_time.pkl"), "rb") as pkl_eigen_file:
    lst_eigen_time: list = pickle.load(pkl_eigen_file)

with open(os.path.join(FILE_DIR, "saved_results", "pos_discharge_rest_eigen_soc.pkl"), "rb") as pkl_eigen_file:
    lst_eigen_soc: list = pickle.load(pkl_eigen_file)

with open(os.path.join(FILE_DIR, "saved_results", "pos_discharge_rest_poly_time.pkl"), "rb") as pkl_poly_file:
    lst_poly_time: list = pickle.load(pkl_poly_file)

with open(os.path.join(FILE_DIR, "saved_results", "pos_discharge_rest_poly_soc.pkl"), "rb") as pkl_poly_file:
