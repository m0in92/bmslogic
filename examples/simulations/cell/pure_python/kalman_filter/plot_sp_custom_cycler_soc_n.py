...
plt.plot(sol.t, sol.x_surf_n, label=r"$SOC_{n,noisy}$")
plt.plot(sol_kf.t, sol_kf.x_surf_n, label=r"$SOC_{n,SPKF}$")
plt.plot(sol_true.t, sol_true.x_surf_n, label=r"$SOC_{n,true}$", linestyle=":")
