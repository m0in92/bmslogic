...
plt.plot(sol.t, sol.x_surf_n, label=r"$SOC_{n,noisy}$", linewidth=3)
plt.plot(sol_kf.t, sol_kf.x_surf_n, label=r"$SOC_{n,SPKF}$", linewidth=3)
plt.plot(sol_true.t, sol_true.x_surf_n, label=r"$SOC_{n,true}$", linestyle=":", linewidth=3)
