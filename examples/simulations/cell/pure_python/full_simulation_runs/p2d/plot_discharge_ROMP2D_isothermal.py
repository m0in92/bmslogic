...
with open(os.path.join(FILE_DIR_TO_OPEN, "discharge_romp2d_isothermal_time.pkl"), "rb") as pkl_file:
    sol_time: list = pickle.load(pkl_file)

with open(os.path.join(FILE_DIR_TO_OPEN, "discharge_romp2d_isothermal_V.pkl"), "rb") as pkl_file:
