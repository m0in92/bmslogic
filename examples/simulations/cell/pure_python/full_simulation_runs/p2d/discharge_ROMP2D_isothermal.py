"""
This script contains the example usage of the simplified P2D for the discharge
operation.
"""
...
solver: cell_sim.PySimplifiedP2D = cell_sim.PySimplifiedP2D(b_cell=cell, isothermal=True, degradation=False)
...
with open(os.path.join(DIR_TO_SAVE, "discharge_romp2d_isothermal_time.pkl"), "wb") as pkl_file:
    pickle.dump(sol.t.tolist(), pkl_file)

with open(os.path.join(DIR_TO_SAVE, "discharge_romp2d_isothermal_V.pkl"), "wb") as pkl_file:
