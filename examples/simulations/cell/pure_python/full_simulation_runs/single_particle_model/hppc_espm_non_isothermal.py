...
with open(os.path.join(DIR_TO_SAVE, "hppc_espm_non_isothermal_time.pkl"), "wb") as pkl_file:
    pickle.dump(sol.t.tolist(), pkl_file)

with open(os.path.join(DIR_TO_SAVE, "hppc_espm_non_isothermal_V.pkl"), "wb") as pkl_file:
