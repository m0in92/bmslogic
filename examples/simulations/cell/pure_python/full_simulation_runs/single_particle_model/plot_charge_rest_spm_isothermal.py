...
with open(os.path.join(FILE_DIR_TO_OPEN, "charge_rest_spm_isothermal_time.pkl"), "rb") as pkl_cn_file:
    sol_time: list = pickle.load(pkl_cn_file)

with open(os.path.join(FILE_DIR_TO_OPEN, "charge_rest_spm_isothermal_V.pkl"), "rb") as pkl_cn_file:
