...
# ----------------------------------------OPEN FILES------------------------------------------------------------------------
FILE_DIR_TO_OPEN: str = os.path.join(pathlib.Path(
    __file__).parent.__str__(), "saved_results")

with open(os.path.join(FILE_DIR_TO_OPEN, "charge_spm_isothermal_time.pkl"), "rb") as pkl_cn_file:
...
plt.plot(sol_spm_non_isothermal_time,
         sol_spm_non_isothermal_V, label="SPM-non_isothermal", linewidth=3)
plt.plot(sol_espm_time, sol_espm_V, label="Enhanced SPM", linewidth=3)
plt.plot(sol_espm_non_isothermal_time, sol_espm_non_isothermal_V,
         label="Enhanced SPM-non_isothermal", linewidth=3)
