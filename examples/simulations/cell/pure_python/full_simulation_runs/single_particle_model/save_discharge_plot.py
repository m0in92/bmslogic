...
import pathlib
# os and pathlib are used for defining the current module's abolute file path.
import os
...
# Plot
sol.comprehensive_plot(save_dir=os.path.join(
    pathlib.Path(__file__).parent.__str__(), "saved_results", "isothermal_discharge.png"))
