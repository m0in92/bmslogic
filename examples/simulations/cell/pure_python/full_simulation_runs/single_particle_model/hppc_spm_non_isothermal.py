...
# cycler.plot()
solver = cell_sim.PySPSolver(b_cell=cell, isothermal=False, degradation=False,
...
with open(os.path.join(DIR_TO_SAVE, "hppc_spm_non_isothermal_time.pkl"), "wb") as pkl_file:
    pickle.dump(sol.t.tolist(), pkl_file)

with open(os.path.join(DIR_TO_SAVE, "hppc_spm_non_isothermal_V.pkl"), "wb") as pkl_file:
