...
if __name__ == "__main__":
    ...
    solver_espm: cell_sim.ESPBatterySolver = cell_sim.ESPBatterySolver(battery_cell=battery_cell,
                                                                       is_isothermal=True,
                                                                       enable_degradation=False)
    sol_espm: cell_sim.Solution = solver_espm.solve(cycler=cycler)

    # plots
    plt.plot(sol_espm.t, sol_espm.V)
    plt.plot(sol_espm.t, sol_espm.overpotential_elec_p)
