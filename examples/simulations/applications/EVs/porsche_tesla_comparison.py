"""
Example that illustrates the comparison of EVs
"""
...
us06: EV_sim.EVDriveCycle = EV_sim.EVDriveCycle(drive_cycle_name="us06")
hwfet: EV_sim.EVDriveCycle = EV_sim.EVDriveCycle(drive_cycle_name="hwfet")
udds: EV_sim.EVDriveCycle = EV_sim.EVDriveCycle(drive_cycle_name="udds")
nycc: EV_sim.EVDriveCycle = EV_sim.EVDriveCycle(drive_cycle_name="nycc")
ftp: EV_sim.EVDriveCycle = EV_sim.EVDriveCycle(drive_cycle_name="ftp")
bcdc: EV_sim.EVDriveCycle = EV_sim.EVDriveCycle(drive_cycle_name="bcdc")

std_condition: EV_sim.ExternalConditions = EV_sim.ExternalConditions(rho=1.225, road_grade=0.3)

tesla_model_us06: EV_sim.EVDynamics = EV_sim.EVDynamics(ev_obj=tesla, drive_cycle_obj=us06,
                                                                  external_condition_obj=std_condition)
tesla_model_hwfet: EV_sim.EVDynamics = EV_sim.EVDynamics(ev_obj=tesla, drive_cycle_obj=hwfet,
                                                                   external_condition_obj=std_condition)
tesla_model_udds: EV_sim.EVDynamics = EV_sim.EVDynamics(ev_obj=tesla, drive_cycle_obj=udds,
                                                                  external_condition_obj=std_condition)
tesla_model_nycc: EV_sim.EVDynamics = EV_sim.EVDynamics(ev_obj=tesla, drive_cycle_obj=nycc,
                                                                  external_condition_obj=std_condition)
tesla_model_ftp: EV_sim.EVDynamics = EV_sim.EVDynamics(ev_obj=tesla, drive_cycle_obj=ftp,
                                                                 external_condition_obj=std_condition)
tesla_model_bcdc: EV_sim.EVDynamics = EV_sim.EVDynamics(ev_obj=tesla, drive_cycle_obj=bcdc,
                                                                  external_condition_obj=std_condition)

porche_model_us06: EV_sim.EVDynamics = EV_sim.EVDynamics(ev_obj=porche, drive_cycle_obj=us06,
                                                                   external_condition_obj=std_condition)
porche_model_hwfet: EV_sim.EVDynamics = EV_sim.EVDynamics(ev_obj=porche, drive_cycle_obj=hwfet,
                                                                    external_condition_obj=std_condition)
porche_model_udds: EV_sim.EVDynamics = EV_sim.EVDynamics(ev_obj=porche, drive_cycle_obj=udds,
                                                                   external_condition_obj=std_condition)
porche_model_nycc: EV_sim.EVDynamics = EV_sim.EVDynamics(ev_obj=porche, drive_cycle_obj=nycc,
                                                                   external_condition_obj=std_condition)
porche_model_ftp: EV_sim.EVDynamics = EV_sim.EVDynamics(ev_obj=porche, drive_cycle_obj=ftp,
                                                                  external_condition_obj=std_condition)
porche_model_bcdc: EV_sim.EVDynamics = EV_sim.EVDynamics(ev_obj=porche, drive_cycle_obj=bcdc,
                                                                   external_condition_obj=std_condition)
