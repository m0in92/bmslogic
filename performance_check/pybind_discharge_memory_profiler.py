"""
Checks for the memory profile during a constant current discharge
"""
...
@profile
def run_simulation(store_solution_iter: int) -> cell_sim.Solution:
    ...
    sol: cell_sim.Solution = solver.solve(cycler=dc, store_solution_iter=store_solution_iter)
    return sol


sol1: cell_sim.Solution = run_simulation(store_solution_iter=1)   # after 3 runs  6.9, 7.0, 7.1 MB
sol2: cell_sim.Solution = run_simulation(store_solution_iter=10)   # after 3 runs  0.1, 0.1, 0.1 MB
sol3: cell_sim.Solution = run_simulation(store_solution_iter=100)   # after 3 runs  0.0, 0.0, 0.0 MB
