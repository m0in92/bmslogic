...
class PyEigenFuncExp(PyBaseElectrodeConcSolver):
    ...
    def lambda_bounds(self) -> np.ndarray:
        """
    ...
    @property
    def lambda_roots(self) -> np.ndarray:
        """
...
class PyCNSolver(PyBaseElectrodeConcSolver):
    """
...
class PyPolynomialApproximation(PyBaseElectrodeConcSolver):
    """
