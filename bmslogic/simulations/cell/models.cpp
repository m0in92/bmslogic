...
OverPotentials SPModel::calc_overpotentials(double OCP_p, double OCP_n, double m_p, double m_n, double R_cell, double T, double I)
{
    ...
    return {terminal_V, OCV, overpotential_elec_p, overpotential_elec_n, overpotential_R_cell, 0};
